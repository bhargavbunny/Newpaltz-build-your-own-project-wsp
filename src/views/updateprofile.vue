<template>
  ...
  <div class="form-group">
    ...
    <input type="password" class="form-control" id="Birthday" placeholder="Password">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Weight</label>
    <input type="password" class="form-control" id="Weight" placeholder="Password">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">height</label>
    <input type="password" class="form-control" id="Height" placeholder="Password">
  </div>
...
export default {
  data: () => ({
    data: {},
    newuser_profile: null,
  }),
  methods: {
    async submit() {
      try {
        const m = await updateprofile(this.data);
        this.user_profile = m;
